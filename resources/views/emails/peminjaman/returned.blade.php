@php
    ...
    $statusLabel = $isFullyReturned ? 'seluruhnya' : 'sebagian';
@endphp
<!DOCTYPE html>
<html lang="id">
<head>
...
<title>Peminjaman Alat Telah Dikembalikan</title>
</head>
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <p style="margin:0 0 16px; font-size:14px; line-height:1.6; color:#374151;">
                Alat untuk peminjaman dari area <strong>{{ $peminjamAreaName }}</strong> telah dikembalikan <strong>{{ $statusLabel }}</strong> sebagai <strong>PIC Tool</strong>.
                @if ($isFullyReturned)
                    Seluruh alat sudah kembali, silakan verifikasi dan selesaikan peminjaman ini.
                @else
                    Masih ada alat yang belum dikembalikan.
                @endif
            </p>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-bottom:24px;">
                <tr>
                    ...
                    <td style="padding:8px 12px; background-color:#f9fafb; border:1px solid #e5e7eb; font-size:13px; color:#6b7280; font-weight:bold; text-align:right;">Qty Kembali</td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="padding:8px 12px; border:1px solid #e5e7eb; font-size:14px; color:#111827; text-align:right;">{{ $item['returned_qty'] }} / {{ $item['approved_qty'] }}</td>
                </tr>
                @endforeach
            </table>
            @endif
