...
<title>Peminjaman Alat Perlu Direview</title>
</head>
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <p style="margin:0 0 16px; font-size:14px; line-height:1.6; color:#374151;">
                Ada pengajuan peminjaman alat baru di area <strong>{{ $peminjamAreaName }}</strong> yang membutuhkan review/persetujuan Anda sebagai <strong>SP Tool</strong>.
            </p>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="border-radius:6px; background-color:#1d4ed8;">
                        <a href="{{ $reviewUrl }}" target="_blank" style="display:inline-block; padding:12px 24px; font-size:14px; color:#ffffff; text-decoration:none; font-weight:bold;">
                            Review Peminjaman Sekarang
                        </a>
                    </td>
                </tr>
            </table>
