...
<title>Peminjaman Alat Telah Dikirim</title>
</head>
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; max-width:600px; width:100%;">
    <tr>
        <td style="background-color:#0369a1; padding:20px 32px;">
    ...
    <tr>
        <td style="padding:32px;">
            ...
            <p style="margin:0 0 16px; font-size:14px; line-height:1.6; color:#374151;">
                Alat untuk peminjaman dari area <strong>{{ $peminjamAreaName }}</strong> telah dikirim. Mohon periksa dan konfirmasi penerimaannya.
            </p>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-bottom:24px;">
                <tr>
                    ...
                    <td style="padding:8px 12px; background-color:#f9fafb; border:1px solid #e5e7eb; font-size:13px; color:#6b7280; font-weight:bold; text-align:right;">Qty Dikirim</td>
                </tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="border-radius:6px; background-color:#0369a1;">
                        <a href="{{ $receiveUrl }}" target="_blank" style="display:inline-block; padding:12px 24px; font-size:14px; color:#ffffff; text-decoration:none; font-weight:bold;">
