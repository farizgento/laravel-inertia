                ...
                <div class="px-6 py-5 text-sm text-slate-600">
                    ...
                    <div class="mt-4">
                        <div class="flex flex-wrap items-start justify-between gap-2">
                            <div>
                                <label class="text-sm font-semibold text-slate-900" for="foto-pengembalian-user">
                                    Foto Pengembalian
                                </label>
                                <p class="mt-1 text-xs text-slate-500">
...
const handleReturnPhotosChange = (event) => {
    ...
    returnReportError.value = errors[0] ?? '';
};
...
const validateReturnReport = () => {
    ...
    if (!returnPhotoItems.value.length) {
        returnReportError.value = 'Minimal satu foto pengembalian wajib diunggah.';
        return false;
    }
