...
class PeminjamanReadyToShipMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: "Peminjaman Alat #{$this->peminjaman->id} Siap Disiapkan & Dikirim",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.peminjaman.ready-to-ship',
            with: [
    ...
    {
        Log::error('Gagal mengirim email persiapan pengiriman peminjaman ke PIC Tool setelah beberapa percobaan.', [
