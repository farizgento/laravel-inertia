...
class PeminjamanShippedMail extends Mailable implements ShouldQueue
{
    ...
    public function __construct(Peminjaman $peminjaman)
    {
        ...
        $route = $peminjaman->is_inter_area ? 'pengiriman-antar-area' : 'riwayat-peminjaman';
        $this->receiveUrl = rtrim((string) config('app.url'), '/') . '/' . $route;
    }

    public function envelope(): Envelope
    {
        return new Envelope(
            subject: "Peminjaman Alat #{$this->peminjaman->id} Telah Dikirim - Mohon Konfirmasi Penerimaan",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.peminjaman.shipped',
            with: [
    ...
    {
        Log::error('Gagal mengirim email pengiriman peminjaman setelah beberapa percobaan.', [
